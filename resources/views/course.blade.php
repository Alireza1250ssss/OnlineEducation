...
<div class="cnt">
    ...
    <div class="row justify-content-between">
        <a href="{{$courseUsers->previousPageUrl()}}" class="col-1 bg-info text-dark text-center rounded-pill px-1 mb-2">previous</a>
        <a href="{{$courseUsers->nextPageUrl()}}" class="col-1 bg-info text-dark text-center rounded-pill px-1 mb-2">next</a>
    </div>
    <ul>
...
<div class="cnt">
    ...
    <div class="row justify-content-between">
        <a href="{{$students->previousPageUrl()}}" class="col-1 bg-info text-dark text-center rounded-pill px-1 mb-2">previous</a>
        <a href="{{$students->nextPageUrl()}}" class="col-1 bg-info text-dark text-center rounded-pill px-1 mb-2">next</a>
